...
class EndermanMob extends EnderMan implements TickableMob {

    String mobCustomName

    EndermanMob(Level world, String customName = "", float scale = 1.0F) {
    ...
    protected boolean damageEntity0(DamageSource damagesource, float f) {
        ...
        if (dmg && mobCustomName != "") {
            this.setCustomName(CraftChatMessage.fromStringOrNull(ColorUtil.color("${mobCustomName} §c${Math.round(getHealth()) as int}§l❤")))
