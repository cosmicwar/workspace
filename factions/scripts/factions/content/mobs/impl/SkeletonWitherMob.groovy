...
class SkeletonWitherMob extends WitherSkeleton implements TickableMob {

    String mobCustomName

    SkeletonWitherMob(Level world, String customName = "", float scale = 1.0F) {
        ...
        this.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(0.3D * scale)
        this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(4.0D * scale)
        this.getAttribute(Attributes.ATTACK_KNOCKBACK).setBaseValue(1.2D * scale)
