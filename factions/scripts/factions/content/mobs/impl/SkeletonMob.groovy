...
class SkeletonMob extends Skeleton implements TickableMob {

    String mobCustomName

    SkeletonMob(Level world, String customName = "", float scale = 1.0F) {
        ...
        this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(5.0D * scale)
