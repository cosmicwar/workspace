        ...
        rules     : [
                ...
                14: [ //left out item as it will default to a book anyways.
                      ...
                      description: [
                              ...
                              "§7more than once with any kind of buy / sell message",
                ...
                17: [
                        ...
                        description: [
                                "§7",
                                "§7Using any form of location",
                                "§7glitching is not allowed. This includes",
                                "§7the use of teleportation commands, ender pearls,",
                                "§7blocks, boats, explosions or any other illegitimate",
                                "§7method to get to locations you are not supposed to have access to."
                        ]
                ],
                18: [ //left out item as it will default to a book anyways.
                      ...
                      description: [
                              "§7",
                              "§7Players who are abusing alts in any way.",
                              "§7Alts should only be used to afk on your island."
                      ]
                ],
                19: [
                        ...
                        description: [
                                ...
                                "§7Staff must have proof of ban. Bypassing AFK checks falls under this rule."
                        ]
                ],
